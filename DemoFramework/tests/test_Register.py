...
class TestRegister:
    ...
    def test_register_with_duplicate_email(self):
        ...
        register_page.enter_first_name("Shubham")
        register_page.enter_last_name("Kumar")
        register_page.enter_email('happy92home@gmail.com')
        register_page.enter_telephone("987654321")
        register_page.enter_password("12345")
        register_page.enter_password_confirm("12345")
        register_page.select_yes_radio_button()
        ...
        assert register_page.retrieve_duplicate_email_warning().__contains__(expected_heading_text)
    ...
    def test_without_entering_any_fields(self):
        ...
        assert register_page.retrieve_first_name_warning().__contains__(expected_first_name_warning_message)

        expected_last_name_warning_message = "Last Name must be between 1 and 32 characters!"
        assert register_page.retrieve_last_name_warning().__contains__(expected_last_name_warning_message)
